...
deterministic trend, where $\hat{\beta}=`r beta[3]`$
...
AR(2) where $\phi_1=0.5, \phi_2=-0.3$
...
deterministic trend, where $\hat{\beta}=`r beta[11]`$
...
deterministic trend, where $\hat{\beta}=`r beta[14]`$
...
deterministic trend, where $\hat{\beta}=`r beta[15]`$
...
deterministic trend, where $\hat{\beta}=`r beta[16]`$
Monthly seasonality
possibly also AR(1)
...
MA(2) where $\psi_1=0.25, \psi_2=0.3$
...
deterministic trend, where $\hat{\beta}=`r beta[18]`$
AR(2) where $\phi_1=0.5, \phi_2=-0.2$
